...
def get_data_spacing(tech_type1, tech_type2, tech_type3, tech_type4):
...
def draw_bar_plot_EffetiveScore_radius(tech_type1, tech_type2, tech_type3, tech_type4):
    data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12 = get_data_radius(tech_type1, tech_type2, tech_type3, tech_type4)
    ...
    data_H_offset_magnitude_type1 = [data1['global_avg_EffectiveScore'], data5['global_avg_EffectiveScore'], data9['global_avg_EffectiveScore']]
    data_H_offset_sem_type1 = [data1['global_sem_EffectiveScore'], data5['global_sem_EffectiveScore'], data9['global_sem_EffectiveScore']]

    data_H_offset_magnitude_type2 = [data2['global_avg_EffectiveScore'], data6['global_avg_EffectiveScore'], data10['global_avg_EffectiveScore']]
    data_H_offset_sem_type2 = [data2['global_sem_EffectiveScore'], data6['global_sem_EffectiveScore'], data10['global_sem_EffectiveScore']]

    data_H_offset_magnitude_type3 = [data3['global_avg_EffectiveScore'], data7['global_avg_EffectiveScore'], data11['global_avg_EffectiveScore']]
    data_H_offset_sem_type3 = [data3['global_sem_EffectiveScore'], data7['global_sem_EffectiveScore'], data11['global_sem_EffectiveScore']]
...
def draw_bar_plot_EffetiveScore_spacing(tech_type1, tech_type2, tech_type3, tech_type4):
    data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12 = get_data_spacing(tech_type1, tech_type2, tech_type3, tech_type4)
